/* ==========================================================================
   Mr. Barista — script.js
   يقرأ البيانات من config.json و database.json ويبني الموقع ديناميكياً.
   ملاحظة: يجب تشغيل الموقع عبر خادم محلي (وليس فتح الملف مباشرة) حتى
   يعمل fetch() بشكل صحيح، مثال: python -m http.server
   ========================================================================== */
...
async function loadData(){
  try{
    ...
    console.warn("تعذّر تحميل ملفات البيانات (شغّل الموقع عبر خادم محلي). استخدام بيانات افتراضية.", err);
...
function applyConfig(){
  ...
  document.getElementById("bannerText").innerHTML =
    `✨ <strong>عرض خاص:</strong> ${CONFIG.banner?.text || ""}`;
...
/* -------------------- حبيبات القهوة العائمة في الواجهة الرئيسية -------------------- */
...
/* -------------------- بيانات احتياطية عند تعذّر fetch (فتح مباشر بدون خادم) -------------------- */
